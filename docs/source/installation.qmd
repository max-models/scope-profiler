...
| `graph`         | `pip install "scope-profiler[graph]"`        | Interactive call graphs via PyVis |
...
| `pproc`         | `pip install "scope-profiler[pproc]"`       | Plotting backends, pandas DataFrames, JupyterLab, SnakeViz, and TUI plotting |
