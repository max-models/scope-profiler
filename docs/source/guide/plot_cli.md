...
`pussgkw /_static/figures/cli/gantt_plot.png :alt: Gantt chart of the mock solver at two MPI ranks :width: 100%`
...
`pussgkw /_static/figures/cli/flame_plot.png :alt: Flame graph of the mock solver, rank 0 :width: 100%`
...
`pussgkw /_static/figures/cli/durations_plot_avg.png :alt: Average duration per call, by region :width: 100%`

`pussgkw /_static/figures/cli/durations_plot_total.png :alt: Total duration, by region :width: 100%`
...
`pussgkw /_static/figures/cli/duration_timeseries_plot.png :alt: Region duration over wall-clock time :width: 100%`
...
`pussgkw /_static/figures/cli/speedup_plot.png :alt: Per-region speedup at 1, 2 and 4 MPI ranks :width: 100%`
...
`pussgkw /_static/figures/cli/gantt_plot_filtered.png :alt: Gantt chart restricted to the solve and assemble regions on rank 0 :width: 100%`
