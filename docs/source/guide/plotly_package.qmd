...
<script type="module">
  const packageUrl = "https://cdn.jsdelivr.net/npm/@scope-profiler/plotly@latest/+esm";
  const { buildGanttFigure, buildDurationsFigure, buildFlameFigure, buildSpeedupFigure, buildDurationTimeseriesFigure, buildHistogramFigure, buildRankHeatmapFigure, buildImbalanceFigure, renderFigure } = await import(packageUrl);
